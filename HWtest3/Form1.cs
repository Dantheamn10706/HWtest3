        ...
        private void UpdateHardwareMetricsToGUI()
        {
            ...
            if (comboBox1.SelectedIndex >= 0 && gpuDatas.Count > comboBox1.SelectedIndex)
            {
                ...
                else
                {
                    ...
                    VRAMbar1.CustomText = $"{selectedGPUData.UsedMemory:N2}/{(int)selectedGPUData.TotalMemory} GB";
            ...
            if (memData != null)
            {
                ...
                RAMProgressBar1.CustomText = $"{memData.UsedMemoryGB:N2}/{(int)memData.TotalMemoryGB} GB";
